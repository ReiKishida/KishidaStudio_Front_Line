...
public:
	...
	{	// フレームの種類
		...
		//Result
		UIFLAME_RESULT_VICTORY,			// 勝利ロゴ
		UIFLAME_RESULT_DEFEAT,			// 敗北ロゴ
		UIFLAME_RESULT_BLUE_EMBREM,		// ブルーチームのエムブレム
		UIFLAME_RESULT_RED_EMBREM,		// レッドチームのエムブレム
		UIFLAME_RESULT_MYTEAMLOGO,		// 自分のチームを示す
