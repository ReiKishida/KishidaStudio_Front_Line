...
CParticle *CParticle::Create(D3DXVECTOR3 pos, int nType)
{
	...
	pParticle = new CParticle;	// メモリを確保
...
// エミッタの設定
//=============================================================================
void CParticle::Set(D3DXVECTOR3 pos, int nType)
{
	m_pos = pos;
	m_nType = nType;
...
// エミッタの位置の設定
//=============================================================================
void CParticle::SetPosParticleEmitter(int nIdx, D3DXVECTOR3 pos)
{
	// 位置を更新
	m_pos = pos;
}
...
// エミッタの削除
//=============================================================================
void CParticle::DestroyParticle(int nIdx)
{
	// 消す
	CParticle::Uninit();
}
...
void CParData::Unload(void)
{
	...
	{// 読み取ったデータを破棄
		if (NULL != m_pParticleData[nCntParticle] && NULL != m_pParticleData)
		{// メモリの開放
	...
	{
		if (NULL != m_pTexture[nCntTexture] && NULL != m_pTexture)
		{// テクスチャの開放
