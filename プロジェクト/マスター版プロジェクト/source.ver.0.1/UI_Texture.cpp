...
HRESULT CUI_TEXTURE::Init(void)
{
	...
	case UIFLAME_TUTORIAL_INST_STRATEGY:
		CScene2D::BindTexture(CTexture::GetTexture(CTexture::TEXTURE_TUTORIAL_INST_STRATEGY));
		CScene2D::SetColor(D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f));
		CScene2D::SetTex(0, 1, 2);
		break;
	...
	case UIFLAME_TUTORIAL_LESSON_STRATEGY:
		CScene2D::BindTexture(CTexture::GetTexture(CTexture::TEXTURE_TUTORIAL_MISSION_STRATEGY));
		CScene2D::SetColor(D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f));
		CScene2D::SetTex(0, 1, 3);
		break;
	...
	case UIFLAME_RESULT_VICTORY:
		CScene2D::BindTexture(CTexture::GetTexture(CTexture::TEXTURE_RESULT_VICTORY));
		CScene2D::SetColor(D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f));
		break;


	case UIFLAME_RESULT_DEFEAT:
		CScene2D::BindTexture(CTexture::GetTexture(CTexture::TEXTURE_RESULT_DEFEAT));
		CScene2D::SetColor(D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f));
		break;


	case UIFLAME_RESULT_BLUE_EMBREM:
		CScene2D::BindTexture(CTexture::GetTexture(CTexture::TEXTURE_RESULT_BLUE_EMBREM));
		CScene2D::SetColor(D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f));
		break;

	case UIFLAME_RESULT_RED_EMBREM:
		CScene2D::BindTexture(CTexture::GetTexture(CTexture::TEXTURE_RESULT_RED_EMBREM));
		CScene2D::SetColor(D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f));
		break;

	case UIFLAME_RESULT_MYTEAMLOGO:
		CScene2D::BindTexture(CTexture::GetTexture(CTexture::TEXTURE_RESULT_MYTEAMLOGO));
		CScene2D::SetColor(D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0f));
		break;
	}
