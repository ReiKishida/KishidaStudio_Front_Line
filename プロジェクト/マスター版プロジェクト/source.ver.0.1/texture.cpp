...
void CTexture::Load(void)
{
	...
	{// テクスチャ名
	 // UI
		...
		{ "data/TEXTURE/matching/battlestart.png" },			// 戦闘開始ロゴ
		...
		// Result
		{ "data/TEXTURE/UI/victory.png" },						// 勝利ロゴ
		{ "data/TEXTURE/UI/defeat.png" },						// 敗北ロゴ
		{ "data/TEXTURE/UI/blue_embrem.png" },					// ブルーチームのエムブレム
		{ "data/TEXTURE/UI/red_embrem.png" },					// レッドチームのエムブレム
		{ "data/TEXTURE/UI/you.png" },							// 自分のチームを示すロゴ

		// Pin
		{ "data/TEXTURE/UI/enemy_pin.png" },					// 敵ののピン
		{ "data/TEXTURE/UI/pin_000.png" },						// 目的地のピン
		{ "data/TEXTURE/UI/friend_pin.png" },					// 仲間のピン

		// Disp
		{ "data/TEXTURE/UI/blue_icon.png" },					// ブルーチームの表示
		{ "data/TEXTURE/UI/blue_icon_w.png" },					// ブルーチームの表示
		{ "data/TEXTURE/UI/blue_icon_d.png" },					// ブルーチームの表示
		{ "data/TEXTURE/UI/red_icon.png" },						// レッドチームの表示
		{ "data/TEXTURE/UI/red_icon_w.png" },						// レッドチームの表示
		{ "data/TEXTURE/UI/red_icon_d.png" },						// レッドチームの表示
