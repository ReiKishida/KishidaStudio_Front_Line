...
public:
	...
	// ドローンのライフ
	int GetDroneLife(void) { return m_nDroneLife; }
	void SetDroneLife(int nDroneLife) { m_nDroneLife = nDroneLife; }

	// ワーカーのライフ
	int GetWorkerLife(void) { return m_nWorkerLife; }
	void SetWorkerLife(int nWorkerLife) { m_nWorkerLife = nWorkerLife; }
...
private:
	...
	static int				m_nDroneLife, m_nWorkerLife;	// AIのライフ
